...
$acc_username = "MarinelM";
$acc_password = "marmend11";
$acc_fullname = "Marinel M. Mendros";
...
if(isset($_REQUEST['login_button']) === true){
	//get the user username and password from the form and compare to the predefined username and password
